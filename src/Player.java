...
public class Player extends Entity implements Fight {
    ...
    // TODO: 플레이어가 데미지를 받는 메서드를 오버라이드하여 구현하세요
    ...
    // TODO: 인벤토리에 아이템을 추가하는 메서드를 구현하세요
    // 1. 인벤토리에 아이템을 추가합니다
    ...
    // TODO: 전체 처치한 몬스터 수를 1 증가시키는 메서드를 구현하세요
    public void incrementKills() {
        // 여기에 코드를 작성하세요
    }

    // TODO: 체력을 완전히 회복시키는 메서드를 구현하세요
